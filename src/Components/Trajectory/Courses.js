            ...
            <div className="py-5 sticky ">
                {
                    courses.map(course => <Link to={`/courses/${course.id}`} key={course.id}>
                        <div data-aos="zoom-out-left" className=" mx-5 my-10 transition duration-200 transform rounded shadow-md  hover:shadow-2xl hover:shadow-cyan-300/50">
                ...
                <section className=" dark:text-gray-100 ">
                    <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                        <div data-aos="fade-right" data-aos-easing="ease-out-cubic"
                            data-aos-duration="1000" rel="noopener noreferrer" href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group  focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-800 rounded">
                            ...
                            <div data-aos="fade-right" data-aos-easing="ease-out-cubic"
                                data-aos-duration="2000" className="p-6 space-y-2 lg:col-span-5">
                        ...
                        <div data-aos="fade-left" data-aos-easing="ease-out-cubic"
                            data-aos-duration="1000" className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            {
