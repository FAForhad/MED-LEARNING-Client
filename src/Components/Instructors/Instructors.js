        ...
        <div className='instructor'>
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div data-aos="fade-right"
                    data-aos-duration="2000" className="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
                    <h2 className="max-w-lg mb-5 font-sans text-3xl font-bold tracking-tight text-teal-400 sm:text-4xl sm:leading-none md:mb-6 group">
                    ...
                    <p data-aos="fade-left"
                        data-aos-duration="2000" className="text-teal-400 lg:text-sm lg:max-w-md">
