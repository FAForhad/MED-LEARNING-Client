            ...
            <div className="relative bg-gray-900 bg-opacity-75">
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    <div className="flex flex-col items-center justify-between xl:flex-row">
                        ...
                        <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-900 dark:text-gray-100">
                            ...
                            <form className="space-y-6 ng-untouched ng-pristine ng-valid">
                                ...
                                <div className="space-y-1 text-sm">
                                    ...
                                    <input type="password" name="password" placeholder="Password" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-100 dark:text-gray-100 focus:dark:border-violet-400" required />
